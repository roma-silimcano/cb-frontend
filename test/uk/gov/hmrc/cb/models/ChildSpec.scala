...
class ChildSpec extends UnitSpec {
  ...
  "Child" should {
    ...
    "instantiate an instance of child" in {
      ...
      val child = new Child(1, Some("123456"), Some("Shane"), Some("Wilson"), Some(DateTime.now()), Genders.Male, false)
      ...
      child.dob.get shouldBe DateTime.now()
    ...
    "return a new instance of a child when calling editFullName" in {
      val child = Child(1, Some("123456"), Some("Shane"), Some("Wilson"), Some(DateTime.now()), Genders.Male, false)
    ...
    "return a new instance of a child when calling unique reference number" in {
      val child = Child(1, Some("34543"), Some("Chris"), Some("Conder"), Some(DateTime.now()), Genders.Male)
